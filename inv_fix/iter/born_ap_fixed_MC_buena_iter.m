%% Construcción del método iterativo de Juan Manuel a partir de datos scattering angulo fijo
clear all
...
load fixed_data_M7.mat

% Grid points: x
[x1,x2,N,h] = create_grid(M, Rz);

%% Aproximacion de Born
 QBo_11=(1/(h^2))*fftshift(ifftn(fftshift(tfQB_11)));
 QBo_21=(1/(h^2))*fftshift(ifftn(fftshift(tfQB_21)));
 QBo_22=(1/(h^2))*fftshift(ifftn(fftshift(tfQB_22)));
 QBo_12=(1/(h^2))*fftshift(ifftn(fftshift(tfQB_12)));
...
for i=1:Nxi
    parfor j=1:Nxi
     ...
     % xi.theta_ortogonal=0, hacemos la siguiente trampa
        ...
        [w1_1,w1_2]=sol_LS_fun(lam,mu,rml*omega1,x1,x2,Rz,R,M,ui1_1,ui1_2,q11,q12,q21,q22);
        [w1m_1,w1m_2]=sol_LS_fun(lam,mu,rml*omega1m,x1,x2,Rz,R,M,ui1m_1,ui1m_2,q11,q12,q21,q22);
        [w1o_1,w1o_2]=sol_LS_fun(lam,mu,rml*omega1o,x1,x2,Rz,R,M,ui1o_1,ui1o_2,q11,q12,q21,q22);
        %ff1=fftshift(fftn(fftshift(q11.*ui1om_1+q12.*ui1om_2)));
        %surf(real(ff1))
        %stop        
        [w1om_1,w1om_2]=sol_LS_fun(lam,mu,rml*omega1om,x1,x2,Rz,R,M,ui1om_1,ui1om_2,q11,q12,q21,q22);
        [w2_1,w2_2]=sol_LS_fun(lam,mu,rml*omega2,x1,x2,Rz,R,M,ui2_1,ui2_2,q11,q12,q21,q22);
        [w2m_1,w2m_2]=sol_LS_fun(lam,mu,rml*omega2m,x1,x2,Rz,R,M,ui2m_1,ui2m_2,q11,q12,q21,q22);
        [w2o_1,w2o_2]=sol_LS_fun(lam,mu,rml*omega2o,x1,x2,Rz,R,M,ui2o_1,ui2o_2,q11,q12,q21,q22);
        [w2om_1,w2om_2]=sol_LS_fun(lam,mu,rml*omega2om,x1,x2,Rz,R,M,ui2om_1,ui2om_2,q11,q12,q21,q22);
        ...
        % (modificadas para generar el error):
        a_pp1_1=p_tfQw1_1;
        a_pp1_2=p_tfQw1_2;
        a_pp1m_1=p_tfQw1m_1;
        a_pp1m_2=p_tfQw1m_2;
        a_pp1o_1=p_tfQw1o_1;
        a_pp1o_2=p_tfQw1o_2;
        a_pp1om_1=p_tfQw1om_2;
        a_pp1om_2=p_tfQw1om_2;
        % originales:
...
%         a_pp1om_2=p_tf1Qom_2+p_tfQw1om_2;
        ...
        % (modificadas para obtener los errores
        a_ps2_1=tfQw2_1-p_tfQw2_1;
        a_ps2_2=tfQw2_2-p_tfQw2_2;
        a_ps2m_1=tfQw2m_1-p_tfQw2m_1;
        a_ps2m_2=tfQw2m_2-p_tfQw2m_2;
        a_ps2o_1=tfQw2o_1-p_tfQw2o_1;
        a_ps2o_2=tfQw2o_2-p_tfQw2o_2;
        a_ps2om_1=tfQw2om_1-p_tfQw2om_1;
        a_ps2om_2=tfQw2om_2-p_tfQw2om_2;
...
% Aproximación de Born
 QB_11=QBo_11-(1/(h^2))*fftshift(ifftn(fftshift(tfQB_11))).*cutoff;
 QB_21=QBo_21-(1/(h^2))*fftshift(ifftn(fftshift(tfQB_21))).*cutoff;
 QB_22=QBo_22-(1/(h^2))*fftshift(ifftn(fftshift(tfQB_22))).*cutoff;
 QB_12=QBo_12-(1/(h^2))*fftshift(ifftn(fftshift(tfQB_12))).*cutoff;
