%% Datos de scattering para el angulo fijo (K>1)
clear all
...
for i=1:Nxi
    parfor j=1:Nxi
     ...
     % xi.theta_ortogonal=0, hacemos la siguiente trampa
        ...
        [w1_1,w1_2]=sol_LS_fun(lam,mu,rml*omega1,x1,x2,Rz,R,M1,ui1_1,ui1_2,q11,q12,q21,q22);
        [w1m_1,w1m_2]=sol_LS_fun(lam,mu,rml*omega1m,x1,x2,Rz,R,M1,ui1m_1,ui1m_2,q11,q12,q21,q22);
        [w1o_1,w1o_2]=sol_LS_fun(lam,mu,rml*omega1o,x1,x2,Rz,R,M1,ui1o_1,ui1o_2,q11,q12,q21,q22);
        %ff1=fftshift(fftn(fftshift(q11.*ui1om_1+q12.*ui1om_2)));
        %surf(real(ff1))
        %stop        
        [w1om_1,w1om_2]=sol_LS_fun(lam,mu,rml*omega1om,x1,x2,Rz,R,M1,ui1om_1,ui1om_2,q11,q12,q21,q22);
        [w2_1,w2_2]=sol_LS_fun(lam,mu,rml*omega2,x1,x2,Rz,R,M1,ui2_1,ui2_2,q11,q12,q21,q22);
        [w2m_1,w2m_2]=sol_LS_fun(lam,mu,rml*omega2m,x1,x2,Rz,R,M1,ui2m_1,ui2m_2,q11,q12,q21,q22);
        [w2o_1,w2o_2]=sol_LS_fun(lam,mu,rml*omega2o,x1,x2,Rz,R,M1,ui2o_1,ui2o_2,q11,q12,q21,q22);
        [w2om_1,w2om_2]=sol_LS_fun(lam,mu,rml*omega2om,x1,x2,Rz,R,M1,ui2om_1,ui2om_2,q11,q12,q21,q22);
