...
%% Compute error
error=error+0.25*sqrt( abs( (real(QB_11-q11)).^2 +(real(QB_12-q12)).^2 ...
    +(real(QB_21-q21)).^2 + (real(QB_22-q22)).^2 ))
error_im=error_im+0.25*sqrt(abs( (imag(QB_11-q11)).^2 +(imag(QB_12-q12)).^2 ...
...
error=error/Numb;
error_im=error_im/Numb;
save('resultados',"error","error_im","Numb","x1r","x2r")
surf(x1r,x2r,error)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Funciones
