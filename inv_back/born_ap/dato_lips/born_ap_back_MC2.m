...
M=7;      % number of points in the x-grid is N=2^M
...
for i=1:Nxi
    parfor j=1:Nxi
        ...
        [w_pp_1,w_pp_2]=sol_LS_fun2(lam,mu,rml*omega,x1,x2,Rz,R,M,ui_pp_1,ui_pp_2,q11,q12,q21,q22);
        [w_ps_1,w_ps_2]=sol_LS_fun2(lam,mu,2*rml/(K+1)*omega,x1,x2,Rz,R,M,ui_ps_1,ui_ps_2,q11,q12,q21,q22);
        [w_ss_1,w_ss_2]=sol_LS_fun2(lam,mu,rm*omega,x1,x2,Rz,R,M,ui_ss_1,ui_ss_2,q11,q12,q21,q22);
        [w_sp_1,w_sp_2]=sol_LS_fun2(lam,mu,2*rm/(1/K+1)*omega,x1,x2,Rz,R,M,ui_sp_1,ui_sp_2,q11,q12,q21,q22);
%         w_pp_1=0*ui_sp_2;
%         w_pp_2=0*ui_sp_2;
%         w_ps_1=0*ui_sp_2;
%         w_ps_2=0*ui_sp_2;
